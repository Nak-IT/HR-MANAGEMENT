...
{{--
<h2>បញ្ជីខេត្ត/រាជធានី</h2>
<table id="table_id" class="table table-striped"></table>
<button type="button" id="btnadd" class="btn btn-success" data-toggle="modal" data-target="#myModal">បន្ថែមខេត្ត/រាជធានីថ្មី</button>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">ព័ត៌មានខេត្ត/រាជធានី</h4>
            ...
            <div class="modal-body">
                ...
                <form method="post" id="form">
                    ...
                    <div class="form-group">
                        <label for="txtProvinceName">ឈ្មោះខេត្ត/រាជធានី៖</label>
                        <input type="text" class="form-control" id="txtProvinceName" placeholder="បញ្ចូលឈ្មោះខេត្ត/រាជធានី" name="txtProvinceName">
                    </div>
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>តារាងខេត្ត/ក្រុង/រាជធានី</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">ទំព័រដើម</a></li>
          <li class="breadcrumb-item active">តារាងខេត្ត/ក្រុង/រាជធានី</li>
        </ol>
      </nav>
    </div>
...
<script>
    ...
    $("#btnsave").click(function() {
        ...
        if ($("#btnsave").text() == "បញ្ចូល") {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ url("update_province") }}/' + province_code,
                data: form_data,
                dataType: 'json',
                success: function (data) {
                    Swal.fire('ជោគជ័យ', data['success'], 'success');
